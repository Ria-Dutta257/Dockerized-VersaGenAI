...
const {getToken} = useAuth()
  ...
  return (
    ...
    text-slate-700'>
      ...
      {/* left column */}
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white 
      rounded-lg border border-gray-200' >
        ...
        border-gray-300 text-gray-600 cursor-pointer' required />
        ...
        text-sm rounded-md border border-gray-300' placeholder='e.g., watch or spoon , Only single object name' 
        required />
