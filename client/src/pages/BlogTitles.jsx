...
const BlogTitles = () => {
  ...
  const blogCategories = ['General', 'Technology', 'Health', 'Business', 'Travel', 'Food',
     'Lifestyle', 'Education'];
  ...
  return (
    ...
    text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200' >
        ...
        text-sm rounded-md border border-gray-300' placeholder='The future of artificial intelligence is...' 
        required />
        ...
        bg-gradient-to-r from-[#C341F6] to-[#8E37EB] text-white px-4 py-2
