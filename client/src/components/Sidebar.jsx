...
import { Eraser, FileText, Hash, House, Image as ImageIcon, LogOut, Scissors, SquarePen, Users } from 'lucide-react';
...
const Sidebar = ({sidebar,setSidebar}) => {
  ...
  return (
    ...
    justify-between items-center max-sm:absolute top-14 bottom-0 ${sidebar? 'translate-x-0':'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out`}>
